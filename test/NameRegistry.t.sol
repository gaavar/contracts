...
contract NameRegistryTest is Test {
    ...
    function testCannotMakeCommitBeforeReplayDelay(address alice, bytes32 secret, address recovery, uint256 delay)
        public
    {
        _disableTrusted();
    ...
    function testCannotRegisterWithInvalidCommitName(address alice, address bob, bytes32 secret, address recovery)
        public
    {
        _assumeClean(alice);
        vm.assume(bob != address(0));
    ...
    function testBid(address alice, address bob, address charlie, address recovery1, address recovery2, uint256 amount)
        public
    {
        _assumeClean(alice);
        _assumeClean(bob);
